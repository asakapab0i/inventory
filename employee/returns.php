...
include("../includes/returns_codes.php");
?>
...

{
	...
	document.write("</div>");
	document.write("<input class='inputnum' type='text' id='did_array["+x+"]' style='visibility:hidden;position:absolute'>");
...
<div class=field>
  ...
  <tr>
    <td width="57%"><div align="center"><h3>Total Reimburst:</h3></div></td>
    <td width="43%"><input readonly='readonly' class='inputstat' type='text' id='due'></td>
    
  </tr>
  <tr>
    <td><div align="center"><h3>Total Paid:</h3></div></td>
...
<input type="text" name="submit_did" style="visibility:hidden;position:absolute" >
...
<input type="text" name="supplier2" style="visibility:hidden;position:absolute" >
<input type="button" class="minibutton2" value="Check Delivery" onclick="inReturn()"/>
</form>   
