...
function checkYourDelivery() {
	...
	//get supplier id
		...
		$getid = mysql_query("SELECT supplier_id,supplier_name FROM supplier WHERE supplier_name = '$supplier2' ") or die(mysql_error());
			
			if(mysql_num_rows($getid)){
		...
		$sql = mysql_query("INSERT INTO delivery 
		(supplier_id, 
		...
		while($count > -1){
				...
				$sql2 = ("INSERT INTO delivery_detail
				(delivery_id,
				product_id,
				delivered_qty,
				d_unit_price,
