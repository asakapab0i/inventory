...
function displaySupplier(){
	...
	$sup = mysql_query("SELECT * FROM supplier") or die(mysql_error());
	
	 
	 echo '<h3>Supplier <select class="inputpname" name="supplier" id="supplier" type="text">';              			 
...
function deliveryNumber(){
	...
	$getdel = mysql_query("SELECT delivery_id FROM delivery");
	$getdelnum = mysql_num_rows($getdel);
	$getdelnum += 1;
	echo '<h3>Delivery Number <input class="input" readonly="readonly" type="text" value="DN000'.$getdelnum.' "></h3><br/>';
	}
